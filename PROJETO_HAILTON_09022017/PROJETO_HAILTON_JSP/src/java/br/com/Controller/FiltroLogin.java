...
public class FiltroLogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //esta logado || httpRequest.getRequestURI().lastIndexOf("Pessoa.do?acao=cadPessoa")>-1
        if(sessao.getAttribute("loginAtivo")!=null   
         || httpRequest.getRequestURI().lastIndexOf("login.html")>-1 || httpRequest.getRequestURI().lastIndexOf("CadastrarUsuario.jsp")>-1){
